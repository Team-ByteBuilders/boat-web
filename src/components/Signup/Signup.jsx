...
function Signup() {
    ...
    const [creds, setCreds] = useState({ email: "", username: "", password: "", cPassword: "" })
    const onChange = (e) => {
        ...
        <div className="card">
            ...
            <div className="signupForm">
                ...
                <div>
                    ...
                    <label className='phnumber' htmlFor="phnumber">CONFIRM PASSWORD</label>
                    <input type="password" name="cpassword" id="cpassword" required placeholder="Re-Enter your password" onChange={onChange} />
                    <button className="signupbtn" disabled={btnDisable}>SignUp</button>
